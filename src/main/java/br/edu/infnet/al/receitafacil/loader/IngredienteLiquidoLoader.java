        ...
        try {
            ...
            try {
                ...
                while(linha != null) {
                    ...
                    IngredienteLiquido liquido = new IngredienteLiquido(campo[0], Integer.parseInt(campo[1]), Float.parseFloat(campo[2]), Float.parseFloat(campo[3]), campo[4], (campo[5].equalsIgnoreCase("S")) ? true : false, (campo[6].equalsIgnoreCase("S")) ? true : false, Float.parseFloat(campo[7]));
