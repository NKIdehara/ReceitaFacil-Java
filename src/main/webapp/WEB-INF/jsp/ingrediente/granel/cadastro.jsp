...
<body>
    ...
    <div class="container">
        <form action="/ingrediente/granel/incluir" method="post">
            <h3>Cadastro de Ingredientes / Granel</h3>
            ...
            <div class="form-check">
                <label class="form-check-label">
                    <input class="form-check-input" type="checkbox" name="perecivel" value="true">Perecível
                </label>
            </div>

            <div class="form-check">                
                <label class="form-check-label">
                    <input class="form-check-input" type="checkbox" name="fracionado" value="true">Fracionado
                </label>
            </div>
