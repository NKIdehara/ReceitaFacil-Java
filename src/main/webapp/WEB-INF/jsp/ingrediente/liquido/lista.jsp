...
<%@ page import ="br.edu.infnet.al.receitafacil.model.domain.IngredienteLiquido"%>
...
<body>
    ...
    <div class="container">
        <form action="/ingrediente/liquido/cadastro" method="get">
            <h3>Ingrediente / Líquido</h3>
        ...
        <% 
            Collection<IngredienteLiquido> ingredientes = new HashSet<IngredienteLiquido>();
